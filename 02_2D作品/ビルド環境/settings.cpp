...
static char *g_TexturName[TEXTURE_MAX] = {
	"data/TEXTURE/SETTINGS/settings_bg.png",
	"data/TEXTURE/SETTINGS/settings_logo1_title.png",
	"data/TEXTURE/SETTINGS/settings_logo2_BGM.png",
	"data/TEXTURE/SETTINGS/settings_logo3_SE.png",
	"data/TEXTURE/SETTINGS/settings_logo4_modoru.png",
	"data/TEXTURE/SETTINGS/settings_logo5_triangle.png",
	"data/TEXTURE/SETTINGS/settings_logo6_soundMark.png",
...
HRESULT InitSettings(void)
{
	...
	g_settingsSelect = 0;
	g_settingsSelectSide = 2;			// 設定画面の横方向のセレクト変数（訳アリで2）
